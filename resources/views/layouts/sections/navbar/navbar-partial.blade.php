...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
    ...
    <li class="nav-item dropdown-language dropdown">
        <a class="nav-link dropdown-toggle hide-arrow position-relative p-2 d-flex align-items-center" href="javascript:void(0);" data-bs-toggle="dropdown" title="{{ __('header.language') ?? 'Language' }}">
        @if(app()->getLocale() === 'ar')
