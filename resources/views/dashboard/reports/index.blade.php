            ...
            <div class="row g-3">
                <div class="col-12 col-md-8">
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" name="search" id="search-report-input" value="{{ request('search') }}" class="form-control" placeholder="{{ __('reports.search_placeholder') }}" autocomplete="off">
                    </div>
                </div>
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <form action="{{ route('reports.destroy', $report->id) }}" method="POST" class="delete-report-form">
                                    @csrf @method('DELETE')
