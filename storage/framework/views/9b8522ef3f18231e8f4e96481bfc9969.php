<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" dir="<?php echo e(app()->getLocale() == 'ar' ? 'rtl' : 'ltr'); ?>" class="layout-menu-fixed layout-compact" data-assets-path="<?php echo e(asset('/assets') . '/'); ?>" dir="ltr" data-skin="default" data-base-url="<?php echo e(url('/')); ?>" data-framework="laravel" data-bs-theme="light" data-template="vertical-menu-template">
...
</html><?php /**PATH C:\laragon\www\RealEstate-Services-Platform\resources\views/layouts/commonMaster.blade.php ENDPATH**/ ?>