    ...
    <div class="col-md-6 mb-4 mb-md-0">
        <div class="card h-100">
            <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-3">
                ...
                <a href="<?php echo e(route('business-accounts.index')); ?>" class="btn btn-outline-primary btn-sm">
                    <i class="bx bx-list-ul me-1"></i> <?php echo e(__('dashboard.view_all')); ?>
            ...
            <div class="table-responsive text-nowrap" style="min-height: 350px;">
                <table class="table table-hover mb-0">
                    ...
                    <tbody class="table-border-bottom-0">
                        <?php $__empty_1 = true; $__currentLoopData = $stats['latest_pending_accounts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-3">
                                        <img src="<?php echo e($account->getFirstMediaUrl('images') ?: asset('assets/img/avatars/1.png')); ?>" class="rounded-circle object-fit-cover">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="fw-medium text-heading small"><?php echo e($account->getTranslation('name', app()->getLocale())); ?></span>
                                        <small class="text-muted" style="font-size: 0.75rem;"><?php echo e($account->user->name); ?></small>
                                    </div>
                                </div>
                            </td>
                            <td><span class="badge bg-label-secondary small"><?php echo e($account->created_at->format('Y-m-d')); ?></span></td>
                            <td class="text-center">
                                <a href="<?php echo e(route('business-accounts.show', $account->id)); ?>" class="btn btn-icon btn-sm btn-outline-secondary" data-bs-toggle="tooltip" title="<?php echo e(__('dashboard.view_details')); ?>">
                        ...
                        <tr>
                            <td colspan="3" class="p-0 border-0">
                                <div class="empty-state-container">
                                    ...
                                    <h6 class="fw-bold mb-1"><?php echo e(__('dashboard.empty_accounts_title')); ?></h6>
                                    <p class="text-muted small mb-0"><?php echo e(__('dashboard.empty_accounts_desc')); ?></p>
                                </div>
                            </td>
                        </tr>
                        <?php endif; ?>
        ...
        <div class="card h-100">
            ...
            <div class="table-responsive text-nowrap" style="min-height: 350px;">
                <table class="table table-hover mb-0">
                    <thead class="table-light">
                        <tr>
                            <th><?php echo e(__('dashboard.property')); ?></th>
                            <th><?php echo e(__('dashboard.price')); ?></th>
                            <th class="text-center"><?php echo e(__('dashboard.action')); ?></th>
                        </tr>
                    </thead>
                    <tbody class="table-border-bottom-0">
                        <?php $__empty_1 = true; $__currentLoopData = $stats['latest_pending_services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-sm me-3">
                                        <img src="<?php echo e($service->getFirstMediaUrl('main_image_service') ?: asset('assets/img/elements/1.jpg')); ?>" class="rounded-3 object-fit-cover">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="fw-medium text-heading small"><?php echo e(Str::limit($service->title, 25)); ?></span>
                                        <small class="text-muted" style="font-size: 0.75rem;"><?php echo e($service->created_at->diffForHumans()); ?></small>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="fw-semibold text-primary"><?php echo e(number_format($service->price_syp)); ?></span>
                            </td>
                            <td class="text-center">
                                <a href="<?php echo e(route('services.show', $service->id)); ?>" class="btn btn-icon btn-sm btn-outline-secondary" data-bs-toggle="tooltip" title="<?php echo e(__('dashboard.view_details')); ?>">
                                    <i class="bx bx-show"></i>
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="3" class="p-0 border-0">
                                <div class="empty-state-container">
                                    ...
                                    <h6 class="fw-bold mb-1"><?php echo e(__('dashboard.empty_services_title')); ?></h6>
                                    <p class="text-muted small mb-0"><?php echo e(__('dashboard.empty_services_desc')); ?></p>
                                </div>
                            </td>
                        </tr>
                        <?php endif; ?>
