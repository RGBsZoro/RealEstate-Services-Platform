...
<?php echo app('Illuminate\Foundation\Vite')('resources/assets/js/dashboards-analytics.js'); ?>
<?php $__env->stopSection(); ?>
            ...
            <div class="d-flex align-items-start row">
                ...
                <div class="col-sm-5 text-center text-sm-left">
                    <div class="card-body pb-0 px-0 px-md-6">
                        <img src="<?php echo e(asset('assets/img/illustrations/man-with-laptop.png')); ?>" height="175" alt="View Badge User" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-6 mb-6 payments">
                <div class="card h-100">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                            <div class="avatar flex-shrink-0">
                                <img src="<?php echo e(asset('assets/img/icons/unicons/paypal.png')); ?>" alt="paypal" class="rounded" />
                            </div>
                            <div class="dropdown">
                ...
                <div class="tab-content p-0">
                    <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                        <div class="d-flex mb-6">
                            <div class="avatar flex-shrink-0 me-3">
                                <img src="<?php echo e(asset('assets/img/icons/unicons/wallet.png')); ?>" alt="User" />
                            </div>
                            <div>
            ...
            <div class="card-body pt-4">
                <ul class="p-0 m-0">
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="<?php echo e(asset('assets/img/icons/unicons/paypal.png')); ?>" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="<?php echo e(asset('assets/img/icons/unicons/wallet.png')); ?>" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="<?php echo e(asset('assets/img/icons/unicons/chart.png')); ?>" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <li class="d-flex align-items-center mb-6">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="<?php echo e(asset('assets/img/icons/unicons/cc-primary.png')); ?>" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                    ...
                    <li class="d-flex align-items-center">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="<?php echo e(asset('assets/img/icons/unicons/cc-warning.png')); ?>" alt="User" class="rounded" />
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
