...
<div class="card rounded-4 overflow-hidden">
    <div class="card-header border-bottom">
        ...
        <form action="<?php echo e(route('reports.index')); ?>" method="GET" id="reports-filter-form">
            <div class="row g-3">
                <div class="col-12 col-md-8">
                    <div class="input-group input-group-merge">
                        <span class="input-group-text"><i class="bx bx-search"></i></span>
                        <input type="text" name="search" id="search-report-input" value="<?php echo e(request('search')); ?>" class="form-control" placeholder="<?php echo e(__('reports.search_placeholder')); ?>" autocomplete="off">
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <select name="status" class="form-select text-capitalize immediate-report-select">
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <form action="<?php echo e(route('reports.destroy', $report->id)); ?>" method="POST" class="delete-report-form">
    ...
    <div class="card-footer border-top d-flex flex-column flex-md-row align-items-center justify-content-between py-3">
        ...
        <div class="pagination-wrapper">
            <?php echo e($reports->appends(request()->query())->links('pagination::bootstrap-5')); ?>
        ...
        if (window.jQuery) {
            $(function() {
                ...
                $(document).on('submit', '.delete-report-form', function(e) {
                    if(!confirm("<?php echo e(__('reports.confirm_delete')); ?>")) {
                        e.preventDefault();
                    }
                });
            });
