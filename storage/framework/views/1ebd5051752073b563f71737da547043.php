...
<head>
    ...
    <title>المحادثة مع <?php echo e($receiver->name); ?></title>
   ...
   <script>
        window.chatConfig = {
            myId: <?php echo e(auth('web')->id()); ?>,
            receiverId: <?php echo e($receiver->id); ?>,
            receiverName: "<?php echo e($receiver->name); ?>"
        };
    </script>
...
<div class="chat-container">
    <div class="chat-header">
        <div class="user-info">
            <div class="avatar">
                <?php if($receiver->hasMedia('admin_avatars')): ?>
                    <img src="<?php echo e($receiver->getFirstMediaUrl('admin_avatars')); ?>" 
                        alt="<?php echo e($receiver->name); ?>" 
                        style="width: 100%; height: 100%; border-radius: inherit; object-fit: cover;">
                <?php else: ?>
                    <?php echo e(substr($receiver->name, 0, 1)); ?>
